          ...
          <div class="relative group">
            ...
            <div class="relative px-7 py-6 bg-white ring-1 ring-gray-900/5 rounded-lg leading-none flex items-top justify-start space-x-6">
              <div class="space-y-2">
                ...
                <a href="https://braydoncoyer.dev/blog/tailwind-gradients-how-to-make-a-glowing-gradient-background" class="block text-indigo-400 group:text-slate-800 transition duration-200" target="_blank">See Payment →</a>
              </div>
